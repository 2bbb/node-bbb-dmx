...
const space_str = bbb.functional.range(16).reduce((x, y) => " " + x, "");
const space_pad = (i, n) => {
    const tmp = space_str + i;
...
class Clients {
    ...
    printBuffer() {
        bbb.functional.range(32).forEach(i => console.log(" ", this.data.slice(16 * i, 16 * i + 16).map(n => "\x1B" + `[38;2;${255-n < 127 ? 0 : 255};${255-n < 127 ? 0 : 255};${255-n < 127 ? 0 : 255};48;2;${n};${n};0m` + space_pad(n, 3) + "\x1B[0m").join("  ")));
    }
